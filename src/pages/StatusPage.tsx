  ...
  return (
    <div className="space-y-10">
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-4xl font-semibold text-slate-900 dark:text-white">Status</h1>
          <p className="mt-2 max-w-2xl text-slate-600 dark:text-slate-300">
            Service health and changelog for productized agents or APIs. Replace with statuspage.io or Better Stack embed when you go live.
          </p>
        </div>
      ...
      <section>
        <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Changelog</h2>
      ...
      <p className="text-sm text-slate-600 dark:text-slate-400">
        Incident comms: link to <Link to="/security" className="font-medium text-violet-600 hover:underline dark:text-violet-300">Security</Link> for customer obligations.
      </p>
    </div>
  )
}
