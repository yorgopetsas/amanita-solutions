...
export function ComponentsPage() {
  ...
  return (
    <div className="space-y-12">
      <header>
        <p className="text-xs font-semibold uppercase tracking-widest text-violet-600 dark:text-violet-300">Studio · Components</p>
        <h1 className="mt-3 font-[family-name:var(--font-display)] text-4xl font-semibold text-slate-900 dark:text-white sm:text-5xl">
          Build faster with components—not copy-paste prompts.
        </h1>
