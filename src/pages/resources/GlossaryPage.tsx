...
export function GlossaryPage() {
  return (
    <article className="space-y-8">
      ...
      <header>
        <h1 className="font-[family-name:var(--font-display)] text-3xl font-semibold text-slate-900 dark:text-white">Agents glossary</h1>
        <p className="mt-3 max-w-2xl text-slate-600 dark:text-slate-300">Shared vocabulary for sales, engineering, and compliance conversations.</p>
      </header>
