...
export function RoiCalculatorPage() {
  ...
  return (
    <article className="space-y-8">
      ...
      <header>
        <h1 className="font-[family-name:var(--font-display)] text-3xl font-semibold text-slate-900 dark:text-white">ROI calculator (demo)</h1>
        <p className="mt-3 max-w-2xl text-slate-600 dark:text-slate-300">
          Illustrative labor savings from partial automation—tune assumptions for your CFO narrative. Not financial advice.
        </p>
      </header>
      ...
      <div className="grid gap-8 rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-6 text-white">
          <p className="text-sm font-medium text-white/90">Estimated monthly labor savings</p>
          <p className="mt-2 font-[family-name:var(--font-display)] text-4xl font-semibold">${savings.toLocaleString()}</p>
          <p className="mt-3 text-xs text-white/80">
            Formula: tickets × minutes ÷ 60 × hourly rate × coverage. Add model spend and implementation amortization separately.
          </p>
          <Link
            to="/contact"
